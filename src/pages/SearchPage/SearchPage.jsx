...
const SearchPage = () => {
  ...
  }, [location.search, fetchBooks, searchBooks, debouncedSearch]);
      ...
      <div className="search-page-container">
        <div className="search-section">
          <div className="search_bar">
            <input
              ...
              autoFocus
            />
            <img className="search-icon" src="https://67c3d0b132682489e1c451c8--whimsical-eclair-9b90f9.netlify.app/Image/Search.png" alt="Search" />
          </div>
        </div>
        ...
        {(searchStatus === 'initial' || searchStatus === 'no-results') && !isLoading && (
          <div className="no-results-container">
            <img
              className="no-search"
              src="https://67c3d0b132682489e1c451c8--whimsical-eclair-9b90f9.netlify.app/Image/no-search.png"
